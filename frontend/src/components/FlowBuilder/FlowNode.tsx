...
import {
  ...
  Upload, Globe, Webhook, Zap, Settings,
} from 'lucide-react';
...
const TYPE_STYLE: Record<string, { color: string; bg: string; border: string }> = {
  ...
  ai_agent: { color: 'text-purple-700 dark:text-purple-300', bg: 'bg-purple-50 dark:bg-purple-900/20', border: 'border-purple-200 dark:border-purple-800' },
