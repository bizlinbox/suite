...
export const DEFAULT_NODE_TYPES: NodeTypeDef[] = [
  ...
  { type: 'send_interactive_list', label: 'List Menu', category: 'Messages', color: 'text-purple-700', bg: 'bg-purple-50', border: 'border-purple-200', defaultSize: { width: 200, height: 120 }, defaultPorts: [{ id: 'in', type: 'input', label: '' }, { id: 'out', type: 'output', label: '' }], defaultData: { body: '', button: '', sections: '' }, fields: [{ key: 'body', label: 'Body', type: 'textarea' }, { key: 'button', label: 'Button', type: 'text' }, { key: 'sections', label: 'Sections (JSON)', type: 'textarea', placeholder: '[{"title":"...","rows":[{"id":"1","title":"Option 1"}]}]' }] },
  // Logic
  { type: 'condition', label: 'Condition', category: 'Logic', color: 'text-orange-700', bg: 'bg-orange-50', border: 'border-orange-200', defaultSize: { width: 200, height: 110 }, defaultPorts: [{ id: 'in', type: 'input', label: '' }, { id: 'true', type: 'output', label: 'True' }, { id: 'false', type: 'output', label: 'False' }], defaultData: { condition_type: 'contains', value: '' }, fields: [{ key: 'condition_type', label: 'Condition Type', type: 'select', options: ['contains', 'exact', 'starts_with', 'ends_with'] }, { key: 'value', label: 'Value', type: 'text', placeholder: 'Text to match' }] },
  { type: 'delay', label: 'Delay', category: 'Logic', color: 'text-cyan-700', bg: 'bg-cyan-50', border: 'border-cyan-200', defaultSize: { width: 200, height: 90 }, defaultPorts: [{ id: 'in', type: 'input', label: '' }, { id: 'out', type: 'output', label: '' }], defaultData: { seconds: 5 }, fields: [{ key: 'seconds', label: 'Seconds', type: 'number' }] },
  // Actions
